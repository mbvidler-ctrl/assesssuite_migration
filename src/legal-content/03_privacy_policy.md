...
**Controlled revision:** 2 August 2026, revision 2026-08-02.1, authorised by mission UM-AUTO-20260801-ASSESSSUITE-SPLIT-HOSTING-ANALYTICS
...
- on the production public homepage and public legal pages only, the sanitised public path, event time, aggregate page views, an estimated daily visitor count and external referrer information; Vercel may also derive aggregate country, browser, operating-system and device categories. Query strings and URL fragments are removed from the measured page URL;
- cookie and tracking information described in the Cookie, Analytics and Tracking Notice.

Vercel Web Analytics does not set analytics cookies. Its request-derived visitor hash resets daily and its visitor-session value is discarded after 24 hours. AssessSuite does not configure custom events, UTM reporting, feature-flag analytics, session replay, advertising analytics or an analytics drain, and does not load Web Analytics in the authenticated application or on account, clinical, patient, payment, upload, function or API routes. Patient Data is not authorised for this analytics service.
...
- measure and improve use of the public website through limited aggregate analytics that excludes Patient Data and the authenticated Service;
