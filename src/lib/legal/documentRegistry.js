...
//
// Content source: the 21 July 2026 controlled-revision copies of the AssessSuite policy suite
...
// controlled revision 2026-08-02.2. The AI Notice retains 2026-07-21.2. The
...
export const SUITE_PUBLICATION_AUTHORITY =
  'Mission UM-AUTO-20260720-ASSESSSUITE-REFERRAL-RECOVERY, activated by Maxwell Vidler on 20 July 2026';
...
export const SUITE_STATUS_BANNER =
  'RC-2026.07.19 — EFFECTIVE FROM 19 JULY 2026; CONTROLLED REVISION 2026-08-02.2 EFFECTIVE ONLY THROUGH VERIFIED EXACT-SHA DEPLOYMENT. Function-specific activation gates continue to apply.';
...
export const LEGAL_DOCUMENTS = {
  ...
  privacy: {
    ...
    controlledRevision: '2026-08-02.2',
