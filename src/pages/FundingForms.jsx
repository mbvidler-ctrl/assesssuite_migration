...
const australiaFundingData = [
  {
    id: "medicare",
    title: "Medicare â€” MBS Chronic Disease Management",
    icon: Stethoscope,
    color: "blue",
    badge: "Federal",
    reports_required: [
      "Initial letter to GP (clinic letterhead) â€” client details, functional assessment, goals, outcome measures, intervention plan",
    ...
    item_numbers: [
      "10953 â€” Exercise Physiology individual consultation (CDM)",
      "81100 â€” Exercise Physiology group session (CDM)",
    ],
    key_requirements: [
      ...
      "Referral must be current â€” check expiry date",
      "Medicare rebate: ~$57.10 per individual session (indexed annually)",
      "No standard form â€” use clinic letterhead for all correspondence",
    ],
  ...
  },
  {
    ...
    badge: "Federal",
    reports_required: [
      "Patient Care Plan â€” completed at initial consultation and signed by client",
      "End-of-Cycle Report â€” after 12 sessions or when referral expires (billed as item EP90)",
      "Progress/status update letter â€” if requested by DVA case manager",
    ],
    session_limit: "12 sessions per referral cycle (White/Gold card holders)",
    item_numbers: [
      "EP10 â€” Initial consultation",
      "EP20 â€” Subsequent consultation (individual)",
      "EP40 â€” Group session",
      "EP90 â€” End-of-cycle report",
    ],
    key_requirements: [
    ...
    notes: "DVA fees are set separately from Medicare. Fee schedule updated annually (July). Always use the DVA templates â€” custom formats may cause claim rejection.",
    links: [
  ...
  {
    id: "ndis",
    title: "NDIS â€” National Disability Insurance Scheme",
    icon: Users,
    color: "purple",
    badge: "Federal",
    reports_required: [
      "Initial Assessment Report â€” functional capacity, barriers, goals aligned to NDIS plan",
      "Service Agreement â€” must be signed before services begin",
      "Progress Reports â€” typically quarterly or as requested by participant/LAC/support coordinator",
      "Functional Capacity Evaluation (FCE) â€” if requested as part of plan review",
      "Discharge/Transition Summary â€” when supports cease",
    ],
    key_requirements: [
    ...
    report_tips: [
      ...
      "Goal Achievement: Align all activities with NDIS plan goals â€” quote them directly",
  ...
  {
    id: "workcoverqld",
    title: "Workers' Compensation â€” QLD (WorkCover QLD)",
    icon: Briefcase,
    color: "orange",
    badge: "State â€” QLD",
    reports_required: [
      "Provider Management Plan (PMP) â€” within first 5 sessions",
      "Progress Review Report â€” every 4â€“6 weeks or as requested",
      "Capacity Certificate / Work Status Report â€” as directed by insurer",
      "Discharge / RTW Summary â€” at end of episode of care",
    ],
    key_requirements: [
  ...
  {
    id: "siraNSW",
    title: "Workers' Compensation â€” NSW (SIRA / icare)",
    icon: Briefcase,
    color: "orange",
    badge: "State â€” NSW",
    reports_required: [
      "Allied Health Treatment Request (AHTR) â€” required for treatment approval beyond initial sessions",
      "Allied Health Progress Report â€” every 4â€“6 weeks",
      "Initial Assessment Report â€” functional status, goals, RTW plan",
      "Discharge Summary â€” at end of episode of care",
    ],
    key_requirements: [
  ...
  {
    id: "workcoverVIC",
    title: "Workers' Compensation â€” VIC (WorkSafe Victoria)",
    icon: Briefcase,
    color: "orange",
    badge: "State â€” VIC",
    reports_required: ["Initial Assessment Report","Treatment Plan â€” submitted for approval","Progress Reviews every 4â€“6 weeks","Discharge Summary"],
    key_requirements: [
  ...
  {
    id: "rtwSA",
    title: "Workers' Compensation â€” SA (ReturnToWorkSA)",
    icon: Briefcase,
    color: "orange",
    badge: "State â€” SA",
    reports_required: ["Initial Assessment Report","Recovery/RTW Plan","Progress Reports â€” 4â€“6 weekly","Discharge / Closure Summary"],
  ...
  {
    id: "workcoverWA",
    title: "Workers' Compensation â€” WA (WorkCover WA)",
    icon: Briefcase,
    color: "orange",
    badge: "State â€” WA",
  ...
  {
    id: "tacVIC",
    title: "Motor Accident â€” TAC (VIC)",
    icon: Car,
    color: "yellow",
    badge: "State â€” VIC",
    reports_required: ["Initial Functional Assessment â€” injury summary, functional deficits, goals","Treatment Plan â€” with expected sessions and milestones","Progress Reports â€” every 4â€“6 weeks or when requesting further sessions","Discharge Summary"],
  ...
  {
    id: "maicQLD",
    title: "Motor Accident â€” MAIC (QLD)",
    icon: Car,
    color: "yellow",
    badge: "State â€” QLD",
    reports_required: ["Initial Assessment Report","Treatment Plan","Progress Reports / Invoices","Discharge Summary"],
    key_requirements: ["Services funded under the CTP scheme via MAIC","Claims submitted to the at-fault driver's CTP insurer (Suncorp, Allianz, QBE, RACQ)","Insurer pre-approves ongoing care","Fee schedule set by MAIC â€” check annually"],
    notes: "QLD CTP insurers vary â€” Suncorp, Allianz, QBE, RACQ. Always contact the insurer directly for claim number and authorisation. MAIC oversees the scheme.",
    links: [
  ...
  {
    id: "maOther",
    title: "Motor Accident â€” Other States (NRMA, CTP, etc.)",
    icon: Car,
    color: "yellow",
    badge: "Multi-State",
    reports_required: ["Initial Assessment Report","Treatment Plan (approved by insurer)","Progress Reports","Discharge Summary"],
    key_requirements: ["NSW: SIRA CTP scheme â€” submit to fault insurer (NRMA, Allianz, QBE, etc.)","SA: CTP scheme managed by the Motor Accident Commission (now administered via approved insurers e.g. EML) â€” approval via insurer","WA: Insurance Commission of WA (ICWA)","ACT: MACA scheme via ACT Insurance Authority","TAS: Motor Accidents Insurance Board (MAIB)","Each state has its own fee schedule and approval process"],
  ...
  {
    id: "myagedcare",
    title: "My Aged Care â€” Home Care Packages (HCP)",
    icon: Home,
    color: "green",
    badge: "Federal",
    reports_required: ["Initial Functional Assessment â€” ADL function, mobility, risk factors, goals","Individual Care Plan â€” aligned to client's HCP goals","Progress Notes â€” as per service agreement frequency","Annual Review Report â€” recommended for case manager","Discharge Summary â€” when services end"],
    session_limit: "Determined by HCP level (L1â€“L4) and package budget",
    key_requirements: ["Client must be approved for HCP through My Aged Care portal","Services funded through HCP provider (not billed directly to My Aged Care)","Service Agreement required with client and package provider","Package Level 1: ~$10,271/yr, Level 2: ~$17,951/yr, Level 3: ~$38,597/yr, Level 4: ~$58,689/yr (2024â€“25)","Focus on: maintaining independence, falls prevention, mobility, function","Transition to Support at Home program from July 2025"],
  ...
  },
  {
    ...
    links: [
      ...
      { name: "My Aged Care â€” CHSP", url: "https://www.myagedcare.gov.au/help-at-home/commonwealth-home-support-programme" },
    ],
  },
  {
    id: "privatehealth",
  ...
  },
  {
    ...
    color: "gray",
    badge: "Private",
    reports_required: ["No mandatory reports â€” provide as clinically indicated","Standard treatment notes for own records","Referral letters to GP or specialists if requested"],
    key_requirements: ["Fee set by practice â€” no schedule constraints","Invoice with ABN, provider number, and itemised service description","Offer receipt for potential tax deduction (if medically related)"],
  ...
  },
  {
    ...
    key_requirements: ["Cancer Council programs vary by state â€” exercise physiology often funded via grants","Cancer Council WA: Life Now Exercise Program","Cancer Council QLD / Livestrong programs â€” check local availability","Prostate Cancer Foundation, Breast Cancer Network â€” specific programs","Some programs accessed via GP referral or direct self-referral"],
    ...
    links: [
      { name: "Cancer Council WA â€” Life Now Exercise", url: "https://cancerwa.asn.au/health-professionals/allied-health-professionals/" },
  ...
  },
  {
    ...
    color: "teal",
    badge: "State",
    reports_required: ["Varies by program â€” follow individual program guidelines","Standard assessment and progress reports usually required"],
...
const usaFundingData = [
  {
    ...
    color: "blue",
    badge: "Universal",
    reports_required: ["Initial Evaluation / Examination â€” patient history, objective findings, functional status, diagnosis","Plan of Care (POC) â€” goals, frequency, duration, skilled need justification","Progress Report / Re-examination â€” periodic, with outcome measures showing change","Discharge Summary â€” outcomes achieved, home program, recommendations","Prior Authorization Packet â€” when required by payer"],
    key_requirements: ["Always include objective outcome measures (TUG, 6MWT, FIM, etc.) with pre/post data","Document 'skilled need' explicitly â€” why a licensed clinician is required","Show functional progress toward measurable goals","Keep all signatures, dates, and NPI numbers complete","Retain records for minimum 7 years (varies by state)"],
  ...
  {
    id: "usa-medicare",
    title: "Medicare (Part B) â€” Outpatient Rehab Therapy",
    icon: Stethoscope,
    color: "blue",
    badge: "Federal",
    reports_required: ["Initial Evaluation / Examination","Plan of Care (POC) â€” physician/NPP certification required every 90 days","Progress Report â€” required at least every 10 treatment days (functional maintenance)","Discharge Summary","Functional Limitation Reporting (G-codes) â€” on applicable claims"],
    session_limit: "No hard cap â€” subject to therapy cap exceptions & KX modifier above $2,230/year (2024)",
    key_requirements: ["Physician or NPP must certify/re-certify the plan of care","KX modifier required when therapy cap threshold is exceeded (medical necessity documentation required)","AT modifier required for maintenance therapy (chronic conditions)","CMS PQRS/Quality Payment Program â€” report applicable measures","Medicare Advantage (Part C) plans may have additional requirements","Telehealth PT/OT covered under select circumstances (check current CMS guidance)"],
    notes: "Medicare audits are common. Keep documentation airtight â€” skilled need, functional goals, measurable progress. Use CMS MLN resources as your documentation benchmark.",
    links: [
  ...
  },
  {
    ...
    color: "purple",
    badge: "Federal / State",
    reports_required: ["Initial Evaluation / Examination","Prior Authorization Packet â€” required in most states for PT/OT/SLP","Plan of Care (POC)","Progress Reports â€” for re-authorization","Discharge Summary"],
    key_requirements: ["Medicaid rules vary significantly by state â€” always check state-specific Medicaid manual","Most states use Managed Care Organizations (MCOs) â€” each MCO has its own auth process","Prior auth denial is common; build objective, functional justification into every packet","EPSDT covers children â€” broader scope than adult Medicaid","Session limits vary: typically 20â€“60 visits/year depending on state and diagnosis"],
    ...
    links: [
      ...
      { name: "MACPAC â€” Prior Auth in Medicaid (PDF)", url: "https://www.macpac.gov/wp-content/uploads/2024/08/Prior-Authorization-in-Medicaid.pdf" },
    ],
  },
  {
    id: "usa-chip",
    title: "CHIP â€” Children's Health Insurance Program",
    icon: Heart,
    color: "pink",
    badge: "Federal / State",
    ...
    key_requirements: ["Covers children in families that earn too much for Medicaid but cannot afford private insurance","Administered by states â€” documentation requirements similar to state Medicaid","EPSDT benefit applies","Most states process CHIP and Medicaid through the same MCO networks"],
    ...
    links: [
      { name: "CHIP Overview â€” healthcare.gov", url: "https://www.healthcare.gov/medicaid-chip/childrens-health-insurance-program/" },
      { name: "Medicaid.gov â€” CHIP State Plans", url: "https://www.medicaid.gov/chip/state-program-information/index.html" },
    ],
  },
  {
    id: "usa-va",
    title: "Veterans Affairs (VA) â€” Community Care Network",
    icon: Shield,
    color: "red",
    badge: "Federal",
    reports_required: ["Initial Evaluation / Examination","Progress Updates â€” as requested or at episode milestones","Discharge Summary â€” submit promptly after services end"],
    key_requirements: ["Community care requires VA referral / authorization â€” do NOT see patient without it","Record authorization number and date on every note and invoice","Submit medical documentation to VA within 30 days of last visit","Optum (TriWest in some regions) manages Community Care Network â€” bill them, not VA directly"],
  ...
  {
    id: "usa-tricare",
    title: "TRICARE â€” Military Health System",
    icon: Shield,
    color: "red",
    badge: "Federal",
    reports_required: ["Initial Evaluation / Examination","Prior Authorization Packet â€” required for most outpatient PT/OT","Progress Report â€” for re-authorization or continued care","Discharge Summary"],
    key_requirements: ["Must be a TRICARE-authorized provider","TRICARE Prime requires referral from Primary Care Manager (PCM)","TRICARE Select: no referral needed but prior auth may apply","TRICARE For Life (TFL): Medicare crossover plan â€” follow Medicare documentation rules"],
    ...
    links: [
      { name: "TRICARE â€” Referrals and Pre-Authorizations", url: "https://tricare.mil/GettingCare/ReferralsPreAuth" },
  ...
  },
  {
    ...
    color: "orange",
    badge: "State",
    reports_required: ["Initial Work Capacity Evaluation","Initial Assessment Report â€” diagnosis, mechanism of injury, treatment plan","Work Status Report / Capacity Certificate â€” periodic, with explicit RTW restrictions","Progress Report â€” every 4â€“6 weeks","FCE â€” often requested at claim closure or dispute","Discharge / RTW Summary"],
    key_requirements: ["Rules vary by state â€” each state has its own WC fee schedule and forms","Major states: CA (DWC), TX (TDI), NY (NYSIFS), FL (DFS), IL (IWCC)","California: Most restrictive â€” MTUS guidelines govern treatment decisions","Most states require provider to be on approved/certified provider list"],
  ...
  },
  {
    ...
    color: "pink",
    badge: "Private",
    reports_required: ["Initial Evaluation / Examination","Prior Authorization Packet â€” required by most major plans","Progress Report â€” typically every 4â€“6 weeks for re-authorization","Discharge Summary"],
    key_requirements: ["Prior auth is standard â€” submit early (2â€“3 business days before first visit)","Major insurers: UnitedHealthcare, Anthem (BCBS), Aetna, Cigna, Humana","CPT codes: 97110 (therapeutic exercise), 97530 (therapeutic activities), 97001 (initial eval)","Visit limits vary: typically 20â€“60 visits/year"],
  ...
  },
  {
    ...
    notes: "Self-pay is increasingly common for concierge or direct-pay PT practices. Still document clinically as if billing insurance â€” it protects you legally.",
    links: [{ name: "CMS â€” No Surprises Act (Good Faith Estimate)", url: "https://www.cms.gov/nosurprises/consumers/good-faith-estimates" }],
  },
  {
    ...
    color: "yellow",
    badge: "State / Private",
    reports_required: ["Initial Evaluation / Examination","Accident-related injury documentation","Progress Reports â€” submitted to adjuster","Functional Status Reports","Discharge Summary","Medical-legal report (if litigation involved)"],
    key_requirements: ["PIP (Personal Injury Protection) â€” no-fault states: FL, NY, NJ, MI, PA, etc.","At-fault states: bill at-fault driver's liability insurer (via attorney or adjuster)","Letter of Protection (LOP): attorney guarantees payment from settlement","Documentation must link all findings to the accident (causation is key)"],
    notes: "Auto injury cases often involve attorneys. If you receive a letter of protection, ensure your practice has a written agreement. Document every session â€” these records may be used in court.",
    links: [{ name: "NCSL â€” No-Fault Auto Insurance Laws by State", url: "https://www.ncsl.org/financial-services/auto-insurance/no-fault-auto-insurance" }],
  },
  {
    id: "usa-schoolbased",
    ...
    color: "teal",
    badge: "Federal / State",
    reports_required: ["Evaluation Report â€” per IDEA Part B (school age) or Part C (early intervention)","Individualized Education Program (IEP) â€” PT/OT goals and minutes","IFSP (Individualized Family Service Plan) â€” for Part C (0â€“3 years)","Progress Reports â€” tied to IEP reporting periods","Annual Review / Re-evaluation (every 3 years)"],
    key_requirements: ["Part B (3â€“21 years): PT/OT services written into IEP by the school team","Part C (0â€“3 years): Early intervention services via IFSP","All services must relate to educational performance, not medical need"],
    ...
    links: [{ name: "IDEA â€” OSERS Overview", url: "https://sites.ed.gov/idea/" }],
  },
  {
    id: "usa-hospice",
    ...
    reports_required: ["Comfort-focused evaluation â€” function, safety, comfort goals","Plan of Care contributions within the interdisciplinary team (IDT)","Progress Notes","IDT meeting documentation"],
    key_requirements: ["PT/OT services in hospice must be comfort-focused (not rehabilitative)","Included in Medicare Hospice Benefit (per diem rate â€” no separate PT/OT billing)","Palliative care (non-hospice): may bill Medicare Part B or commercial normally"],
    notes: "In hospice, PT/OT is part of the bundled per diem â€” not separately billed. In palliative care clinics (non-hospice), standard outpatient billing applies.",
    links: [
      { name: "CMS Hospice Benefit Overview", url: "https://www.cms.gov/Medicare/Medicare-Fee-for-Service-Payment/Hospice" },
      { name: "APTA â€” Hospice and Palliative Care", url: "https://www.apta.org/your-practice/practice-settings/hospice-and-palliative-care" },
    ],
  },
];
...
const ukFundingData = [
  {
    ...
    color: "blue",
    badge: "NHS England",
    reports_required: ["Initial Assessment Report â€” baseline fitness, health screen, contraindications, goals","Progress Report â€” mid-programme update to referring GP/practice nurse","Completion/Discharge Report â€” outcomes, adherence, recommendations for ongoing activity","Non-Completion Report â€” if client exits early, reason documented"],
    session_limit: "Typically 12â€“24 weeks depending on local ICB commissioning",
    key_requirements: ["Referral must come from a GP, practice nurse, or other qualified healthcare professional","Client must have a long-term condition, be sedentary, or be at clinical risk","Exercise professionals must hold Level 3 Exercise Referral qualification (REPs/CIMSPA recognised)","PARQ+ or equivalent pre-participation health screen required","Schemes vary by ICB (Integrated Care Board) â€” always get local ERS pathway documentation"],
    ...
    links: [
      { name: "NICE PH54 â€” Exercise Referral Guideline", url: "https://www.nice.org.uk/guidance/ph54" },
      { name: "CIMSPA â€” Exercise Referral Standards", url: "https://www.cimspa.co.uk/library-and-resources/cimspa-professional-standards/" },
      { name: "CEP-UK â€” Clinical Exercise Physiology UK", url: "https://www.clinicalexercisephysiology.org.uk" },
      { name: "AHCS â€” Clinical Exercise Physiologist Register", url: "https://www.ahcs.ac.uk" },
    ],
  },
  {
    id: "uk-nhs-cardiac",
    ...
    color: "red",
    badge: "NHS England",
    reports_required: ["Initial Clinical Assessment â€” CPET results, cardiovascular risk, contraindications, goals","Phase III Completion Report â€” discharge outcomes including exercise capacity, risk factor change","Phase IV Referral Letter â€” onward referral to community maintenance programme","Adverse Event Report â€” any clinical incidents during exercise sessions"],
    session_limit: "Phase III: typically 8â€“12 weeks (BACPR standard); Phase IV: ongoing community",
    key_requirements: ["Must follow BACPR (British Association for Cardiovascular Prevention & Rehabilitation) standards","Minimum qualification: Level 4 Exercise Instructor â€” Cardiac Rehabilitation","NACR (National Audit of Cardiac Rehabilitation) data submission required for NHS teams","Risk stratification using validated tools (e.g. CPET, Bruce protocol, ISWT)"],
    ...
    links: [
      { name: "BACPR â€” Standards and Core Components", url: "https://www.bacpr.com" },
      { name: "NACR â€” National Audit of Cardiac Rehab", url: "https://www.nacr.org.uk" },
      { name: "NICE NG185 â€” Cardiac Rehab Guideline", url: "https://www.nice.org.uk/guidance/ng185" },
    ],
  },
  {
    id: "uk-nhs-pulmonary",
    ...
    color: "teal",
    badge: "NHS England",
    reports_required: ["Initial Assessment â€” spirometry, MRC dyspnoea scale, 6MWT or ISWT, SGRQ/CAT","Mid-Programme Review â€” attendance, progress, clinical changes","Completion Report â€” outcome measures, exercise capacity change, PROM scores, onward referral","Non-Completion/Dropout Report â€” reason and clinical status at exit"],
    ...
    links: [
      { name: "NICE NG115 â€” Pulmonary Rehabilitation", url: "https://www.nice.org.uk/guidance/ng115" },
  ...
  },
  {
    ...
    color: "purple",
    badge: "NHS / Macmillan",
    reports_required: ["Holistic Needs Assessment (HNA) â€” completed with patient pre/post programme","Initial Exercise Assessment â€” fitness level, contraindications, treatment-related side effects","MOVE More Progress Report â€” attendance, exercise capacity, wellbeing outcomes","End-of-Programme Report â€” outcomes, recommendations, onward referral"],
    session_limit: "Varies by programme â€” typically 8â€“12 weeks",
  ...
  },
  {
    ...
    color: "green",
    badge: "Private",
    reports_required: ["Initial Assessment / Consultation Report","Treatment / Rehabilitation Plan","Progress Reports â€” at intervals required by insurer (typically every 4â€“6 sessions)","Discharge Report"],
  ...
  },
  {
    ...
    color: "orange",
    badge: "DWP / Employer",
    reports_required: ["Functional Capacity / Work Capacity Assessment Report â€” physical tolerances and limitations","Return to Work Progress Report â€” for employer, HR, or occupational health","FCE Report â€” if requested by employer, occupational health, or DWP"],
    key_requirements: ["Fit Notes are issued by GPs â€” CEPs support the RTW process with functional reports","Report must address: physical demands of specific job role vs. client's current functional capacity","DWP Work Capability Assessment may use your report as supporting evidence","PIP (Personal Independence Payment) functional reports may support applications"],
    notes: "CEPs are increasingly working in occupational health and RTW settings. Keep reports factual and objective â€” avoid commenting on benefit entitlement.",
    links: [
      { name: "DWP â€” Fit Note Guidance for Employers", url: "https://www.gov.uk/government/publications/fit-note-guidance-for-employers-and-line-managers" },
      { name: "DWP â€” Functional Assessment Guide", url: "https://www.gov.uk/government/collections/functional-assessment-guide" },
    ],
  },
  {
    id: "uk-self-pay",
    ...
    color: "gray",
    badge: "Private",
    reports_required: ["No mandatory payer forms","Clinical notes for own records","GP / Specialist Summary Letter â€” on request"],
    ...
    notes: "Self-pay CEP rates in the UK typically range Â£50â€“Â£120/session (2024). Register with the ICO for data protection. CEP-UK membership provides professional support, CPD resources, and job description templates.",
    links: [
      { name: "ICO â€” Data Protection Registration", url: "https://ico.org.uk/for-organisations/register" },
      { name: "CEP-UK Professional Resources", url: "https://www.clinicalexercisephysiology.org.uk/resources" },
      { name: "RCEP â€” Registered Clinical Exercise Physiologist", url: "https://www.ahcs.ac.uk/registers/clinical-exercise-physiologist" },
    ],
  },
];
...
const canadaFundingData = [
  {
    id: "ca-wsib",
    title: "WSIB â€” Ontario Workplace Safety & Insurance Board",
    icon: Briefcase,
    color: "orange",
    badge: "Province â€” ON",
    reports_required: ["Functional Abilities Form (FAF) â€” must use WSIB-approved form 2647A","Initial Assessment Report â€” injury mechanism, functional limitations, treatment plan","Work Transition Assessment (if applicable) â€” for modified/alternate work planning","Progress Reports â€” typically every 4â€“6 weeks as requested by WSIB case manager","FCE Report â€” requested at claim plateau or dispute","Discharge / Return-to-Work Summary"],
    session_limit: "Pre-approved blocks â€” typically 10â€“15 sessions; extension requires justification",
    key_requirements: ["Must be registered with WSIB as an approved provider before billing","Kinesiologists (R.Kin) are the recognised EP-equivalent in Ontario","Use WSIB Functional Abilities Form (2647A) â€” not custom letterhead","Document work-specific functional tolerances: sit, stand, lift, carry, bend, reach","R.Kin regulated under Ontario Kinesiology Act"],
    ...
    links: [
      { name: "WSIB â€” Health Care Provider Registration", url: "https://www.wsib.ca/en/health-care-providers" },
      { name: "WSIB â€” Functional Abilities Form (FAF)", url: "https://www.wsib.ca/en/functional-abilities-form" },
      { name: "Ontario Kinesiology Association", url: "https://www.oka.on.ca" },
    ],
  },
  {
    id: "ca-worksafebc",
    title: "WorkSafeBC â€” British Columbia",
    icon: Briefcase,
    color: "red",
    badge: "Province â€” BC",
    reports_required: ["Functional Capacity Assessment (FCA) Report â€” WorkSafeBC standardised format","Initial Assessment / Treatment Plan","Progress Reports â€” submitted to WorkSafeBC adjudicator","Work Capacity Evaluation â€” functional tolerances and job demands analysis","Discharge / RTW Summary"],
    session_limit: "Pre-approved blocks â€” adjudicator must approve extensions beyond initial authorisation",
    key_requirements: ["Must be registered with College of Kinesiologists of BC (CKIN)","Regulated under BC Health Professions Act â€” Kinesiology Regulation","Use WorkSafeBC billing codes and approved fee schedule","FCAs must follow WorkSafeBC standardised methodology"],
    notes: "WorkSafeBC fee schedules are published annually. CKIN regulates kinesiology in BC. Always document objective functional measures â€” WorkSafeBC reviews reports for evidence of functional progression.",
    links: [
      { name: "WorkSafeBC â€” Health Care Providers", url: "https://www.worksafebc.com/en/health-care-providers" },
      { name: "College of Kinesiologists of BC (CKIN)", url: "https://www.ckin.bc.ca" },
      { name: "WorkSafeBC â€” Fee Schedules", url: "https://www.worksafebc.com/en/health-care-providers/billing-payments" },
    ],
  },
  {
    id: "ca-wcb-alberta",
    title: "WCB Alberta â€” Workers' Compensation Board",
    icon: Briefcase,
    color: "orange",
    badge: "Province â€” AB",
    reports_required: ["Functional Capacity Evaluation (FCE) Report â€” if requested by WCB adjudicator","Initial Assessment Report","Functional Progress Report â€” every 4â€“6 weeks","Return to Work Readiness Report","Discharge Summary"],
    session_limit: "Pre-approved in blocks â€” typically up to 12 sessions initially",
    ...
    links: [
      { name: "WCB Alberta â€” Health Care Providers", url: "https://www.wcb.ab.ca/health-care-providers/" },
  ...
  },
  {
    ...
    color: "blue",
    badge: "Private",
    reports_required: ["Initial Assessment Summary â€” for insurer or employer plan administrator","Treatment / Rehabilitation Plan","Progress Reports â€” for pre-approval of additional sessions","Discharge Summary"],
    key_requirements: ["Major carriers: Sun Life, Manulife, Canada Life, Blue Cross, Great-West Life, Desjardins","R.Kin or Registered Exercise Physiologist (CEP-CSEP) credential usually required","Kinesiology is covered by many group plans â€” verify eligible disciplines","Annual limits typically CAD $500â€“$1,500 per discipline"],
    notes: "Canadian group benefits plans increasingly cover kinesiology and exercise physiology. Always verify whether the plan covers kinesiology vs physiotherapy vs both â€” they are billed separately.",
    links: [
      ...
      { name: "CSEP â€” CEP Credential", url: "https://csep.ca/certifications/csep-cep/" },
    ],
  },
  {
    id: "ca-vac",
    ...
    color: "red",
    badge: "Federal",
    reports_required: ["Initial Assessment Report","Treatment Plan â€” submitted with prior authorisation request","Progress Reports â€” as requested by VAC case manager","Discharge / Completion Report"],
    ...
    notes: "VAC funds exercise physiology/kinesiology as part of physical rehabilitation for veterans with service-related injuries. Pre-authorisation is mandatory â€” never see a veteran without VAC approval in place.",
    links: [
      { name: "VAC â€” Health and Treatment Benefits", url: "https://www.veterans.gc.ca/en/health-and-wellness" },
  ...
  },
  {
    ...
    notes: "Self-pay kinesiology/exercise physiology rates typically range CAD $80â€“$180/session (2024). Rates vary significantly by province and urban/rural location.",
    links: [
      { name: "Canadian Kinesiology Alliance", url: "https://www.cka.ca" },
      { name: "CSEP â€” Certified Exercise Physiologist", url: "https://csep.ca" },
    ],
  },
];
...
const nzFundingData = [
  {
    id: "nz-acc",
    title: "ACC â€” Accident Compensation Corporation",
    icon: Shield,
    color: "blue",
    badge: "National",
    reports_required: ["Initial Assessment Report â€” injury, functional status, goals, treatment plan","ACC32 Prior Approval Request â€” required for treatment beyond initial allocation","Progress Report â€” submitted with ACC32 extension requests","FCE Report â€” if requested by ACC case manager at claim resolution","Discharge / Completion Summary"],
    session_limit: "Initial allocation typically 6â€“12 sessions; extension via ACC32 prior approval",
    ...
    notes: "New Zealand's ACC system provides universal coverage for physical injury regardless of fault. Exercise physiologists work extensively in ACC-funded rehabilitation. Check the current ACC allied health fee schedule â€” rates are updated annually.",
    links: [
      { name: "ACC â€” For Providers", url: "https://www.acc.co.nz/for-providers/" },
      { name: "ACC32 â€” Prior Approval Form", url: "https://www.acc.co.nz/for-providers/treatment-recovery/prior-approval-treatment" },
    ],
  },
  {
    id: "nz-moh",
    title: "Ministry of Health â€” Disability Support Services",
    icon: Users,
    color: "purple",
    badge: "National",
    reports_required: ["Functional Assessment Report â€” standardised DSS format","Needs Assessment Report â€” completed by NASC","Service Plan / Goals Documentation","Review Report â€” at scheduled review intervals"],
    key_requirements: ["Services must be needs-assessed by a NASC (Needs Assessment Service Coordination)","Funding allocated per individual based on needs assessment","Whaikaha â€” Ministry of Disabled People oversees disability support reform","Enabling Good Lives (EGL) principles guide service delivery"],
    ...
    links: [
      { name: "Whaikaha â€” Ministry of Disabled People", url: "https://www.whaikaha.govt.nz" },
      { name: "Health NZ â€” Disability Support Services", url: "https://www.tewhatuora.govt.nz/for-the-health-sector/disability-support-services" },
    ],
  },
  {
    id: "nz-private",
  ...
  },
  {
    ...
    notes: "Self-pay EP rates in NZ typically range NZD $80â€“$160/session (2024). ACC's no-fault system means most injury-related work is funded via ACC rather than self-pay.",
    links: [
...
const singaporeFundingData = [
  {
    id: "sg-healthiersg",
    title: "Healthier SG â€” MOH Health Promotion Programme",
    icon: Stethoscope,
    color: "red",
    badge: "MOH / National",
    reports_required: ["Allied Health Assessment Report â€” functional status, exercise capacity, chronic disease context","Health Plan Documentation â€” aligned to patient's Healthier SG health plan with enrolled GP","Programme Progress Report â€” outcomes aligned to health plan goals","Completion / Discharge Report"],
    ...
    links: [
      { name: "MOH â€” Healthier SG", url: "https://www.healthiersg.gov.sg" },
      { name: "MOH â€” Allied Health Professions (AHPC)", url: "https://www.moh.gov.sg/hpp/allied-health-professionals" },
    ],
  },
  {
    id: "sg-cdmp",
    title: "CDMP â€” Chronic Disease Management Programme",
    icon: Heart,
    color: "orange",
    badge: "MOH / MediSave",
    reports_required: ["Referral documentation from registered GP or specialist","Initial Exercise Assessment â€” functional capacity, contraindications, chronic disease context","CDMP-aligned Treatment Plan","Progress / Review Report","Discharge Summary with chronic disease outcomes (HbA1c, BP, lipids)"],
    ...
    links: [
      { name: "MOH â€” CDMP Information", url: "https://www.moh.gov.sg/cost-financing/healthcare-schemes-subsidies/chronic-disease-management-programme-(cdmp)" },
      { name: "CPF â€” MediSave for CDMP", url: "https://www.cpf.gov.sg/member/healthcare/using-your-medisave-savings/paying-for-outpatient-treatments" },
    ],
  },
  {
    id: "sg-chas",
    title: "CHAS â€” Community Health Assist Scheme",
    icon: Users,
    color: "blue",
    badge: "MOH / MOF",
    ...
    links: [
      { name: "MOH â€” CHAS Scheme", url: "https://www.chas.sg" },
      { name: "Agency for Integrated Care (AIC)", url: "https://www.aic.sg" },
    ],
  },
  {
    id: "sg-wica",
    title: "WICA â€” Work Injury Compensation Act",
    icon: Briefcase,
    color: "orange",
    badge: "Ministry of Manpower",
    reports_required: ["Medical Assessment Report â€” injury, functional limitations, work capacity","Return-to-Work Plan documentation","Medical Leave / Temporary Incapacity Report","Permanent Incapacity Assessment (if applicable)"],
    ...
    links: [{ name: "MOM â€” Work Injury Compensation", url: "https://www.mom.gov.sg/workplace-safety-and-health/work-injury-compensation" }],
  },
  {
    id: "sg-private",
...
const irelandFundingData = [
  {
    id: "ie-hse",
    title: "HSE â€” Health Service Executive (Public Sector)",
    icon: Stethoscope,
    color: "green",
    badge: "National / Public",
    reports_required: ["Referral accepted from GP, specialist, or physiotherapist","Initial Assessment Documentation â€” functional status, goals, programme plan","Progress Review Notes","Discharge Summary"],
    key_requirements: ["Exercise physiologists in HSE typically employed in cardiac, pulmonary, or cancer rehab","CORU registration required for applicable AHP roles","Services commissioned by HSE Community Healthcare Organisations (CHOs)","SlÃ¡intecare reform is expanding chronic disease management community programmes"],
    notes: "Ireland's health system is undergoing major reform under SlÃ¡intecare. Exercise physiology roles are growing in HSE community care, cardiac rehab, and community-based chronic disease management.",
    links: [
      { name: "HSE â€” Allied Health Professions", url: "https://www.hse.ie/eng/about/who/healthallies/ahp/" },
      { name: "CORU â€” Health and Social Care Professionals", url: "https://www.coru.ie" },
      { name: "Irish Heart Foundation â€” Cardiac Rehab", url: "https://www.irishheart.ie/your-heart/cardiac-rehabilitation/" },
    ],
  },
  {
    id: "ie-piab",
    title: "PIAB â€” Personal Injury Assessment Board",
    icon: Car,
    color: "orange",
    badge: "State",
    reports_required: ["Functional Assessment / Expert Report â€” if requested in the personal injury claim process","Medical report supporting treatment received","Attendance records and invoices for services claimed"],
    ...
    links: [{ name: "PIAB â€” Personal Injury Assessment Board", url: "https://www.piab.ie" }],
  },
  {
  ...
  },
  {
    ...
    notes: "Self-pay EP rates in Ireland typically range â‚¬60â€“â‚¬120/session (2024). Clients may claim tax relief on qualified medical expenses under Revenue's Med 2 scheme.",
    links: [
      { name: "CORU â€” Registration for AHPs", url: "https://www.coru.ie" },
      { name: "Revenue â€” Medical Expenses Tax Relief", url: "https://www.revenue.ie/en/personal-tax-credits-reliefs-and-exemptions/health-and-age/health-expenses/index.aspx" },
    ],
  },
];
...
const southAfricaFundingData = [
  {
    ...
    reports_required: ["Initial Assessment Report â€” functional status, clinical context, goals","Pre-authorisation Request Letter â€” required for most scheme benefits","Biokineticist Treatment Plan","Progress / Review Report for continued authorisation","Discharge Summary"],
    session_limit: "Varies by scheme and plan: typically 6â€“12 sessions per benefit cycle",
    key_requirements: ["Biokineticists must be registered with HPCSA (Health Professions Council of SA)","Biokinetics is the South African equivalent of exercise physiology â€” regulated profession","BHF (Board of Healthcare Funders) tariff codes required on all claims","Major schemes: Discovery Health, Momentum Health, Bonitas, Medshield, GEMS","Pre-authorisation required for most rehab services beyond initial sessions"],
    ...
    links: [
      { name: "HPCSA â€” Health Professions Council of SA", url: "https://www.hpcsa.co.za" },
      { name: "BASA â€” BioKinetics Association of SA", url: "https://www.basa.org.za" },
  ...
  },
  {
    ...
    color: "orange",
    badge: "National / DoEL",
    reports_required: ["Biokineticist Treatment Records supporting medical reports","Functional Capacity / Return-to-Work Assessment â€” if requested by Compensation Commissioner","Progress report supporting WCL5 (Progress Medical Report)","Discharge Summary"],
    key_requirements: ["COIDA covers workplace injuries â€” Department of Employment and Labour (DoEL)","Primary medical reports (WCL2, WCL5, final) must be completed by a medical doctor","Biokineticists provide functional restoration and RTW support","HPCSA registration mandatory"],
    ...
    links: [
      { name: "Department of Employment and Labour â€” Compensation Fund", url: "https://www.labour.gov.za/compensation-fund" },
      { name: "RAF â€” Road Accident Fund", url: "https://www.raf.co.za" },
      { name: "BASA â€” Biokinetics Association", url: "https://www.basa.org.za" },
    ],
  },
  {
    id: "za-gems",
    title: "GEMS â€” Government Employees Medical Scheme",
    icon: Users,
    color: "blue",
    badge: "Public Sector",
    ...
    key_requirements: ["GEMS covers South African government employees â€” one of SA's largest medical schemes","Biokinetics covered under Chronic Disease Management and specialist rehab benefits","GEMS requires HPCSA-registered biokineticists","Pre-authorisation required for most rehab services"],
    ...
    links: [
      { name: "GEMS â€” Government Employees Medical Scheme", url: "https://www.gems.gov.za" },
      { name: "BASA â€” Tariff Information", url: "https://www.basa.org.za" },
    ],
  },
  {
    id: "za-self-pay",
    ...
    notes: "Private-pay biokineticist rates in SA typically range ZAR R500â€“R1,200/session (2024). POPIA is South Africa's privacy law â€” registration with the Information Regulator is required for all health practices.",
    links: [
      { name: "BASA â€” BioKinetics Association SA", url: "https://www.basa.org.za" },
      { name: "Information Regulator â€” POPIA", url: "https://www.justice.gov.za/inforeg/" },
      ...
      <CardContent className="space-y-4 flex-grow">
        ...
        {!expanded && funder.links && funder.links.length > 0 && (
          <button onClick={() => setExpanded(true)} className={`text-xs font-medium ${c.icon} hover:underline flex items-center gap-1`}>
            <ExternalLink className="w-3 h-3" />
            {funder.links.length} resource{funder.links.length > 1 ? 's' : ''} available â€” expand to view
          </button>
        )}
      </CardContent>
    </Card>
...
export default function FundingForms() {
  ...
  const banners = {
    australia: { text: `${australiaFundingData.length} Australian funders covered â€” from Medicare and DVA to state-based Workers' Comp, Motor Accident, NDIS, Aged Care, and private insurance.`, sub: "Click any card to expand full requirements, item numbers, report writing tips, and direct links to forms and fee schedules." },
    ...
    uk: { text: `${ukFundingData.length} UK funding pathways covered â€” NHS Exercise Referral, Cardiac & Pulmonary Rehab, Cancer Rehab, PMI, Fit Notes, and private practice.`, sub: "Click any card to expand full requirements, qualifications needed, and direct links to guidelines and provider portals." },
    canada: { text: `${canadaFundingData.length} Canadian funding pathways â€” WSIB Ontario, WorkSafeBC, WCB Alberta, Extended Health Benefits, Veterans Affairs, and private practice.`, sub: "Regulatory requirements vary by province. Always confirm provider registration requirements in your province before billing." },
    nz: { text: `${nzFundingData.length} New Zealand funding pathways â€” ACC (the main pathway), Disability Support, private health insurance, and private practice.`, sub: "ACC's no-fault system covers most injury-related work. Confirm your current ACC contract status and fee schedule before billing." },
    singapore: { text: `${singaporeFundingData.length} Singapore funding pathways â€” Healthier SG, CDMP/MediSave, CHAS, WICA, and corporate/private insurance.`, sub: "Most funded EP services in Singapore are institution-based. AHPC registration and MOH accreditation are essential for public scheme access." },
    ireland: { text: `${irelandFundingData.length} Ireland funding pathways â€” HSE public services, PIAB personal injury, private health insurance (VHI/Laya/Irish Life), and private practice.`, sub: "Exercise physiology is not yet legislatively regulated in Ireland. CORU registration where applicable and professional indemnity insurance are essential." },
    southafrica: { text: `${southAfricaFundingData.length} South Africa funding pathways â€” Medical Aid Schemes, COIDA/Compensation Fund, GEMS, and private practice.`, sub: "Biokinetics is the regulated exercise physiology equivalent in South Africa. HPCSA registration is mandatory for all practice types." },
  };
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-slate-600">Complete guide to documentation requirements, forms, and resources for every funder â€” across all regions.</p>
          </div>
        </div>

        <Tabs value={activeTab} onValueChange={setActiveTab}>
          <TabsList className="flex flex-wrap gap-1 h-auto p-1">
            <TabsTrigger value="australia" className="flex items-center gap-1.5 text-sm">ðŸ‡¦ðŸ‡º Australia</TabsTrigger>
            <TabsTrigger value="usa" className="flex items-center gap-1.5 text-sm">ðŸ‡ºðŸ‡¸ USA</TabsTrigger>
            <TabsTrigger value="uk" className="flex items-center gap-1.5 text-sm">ðŸ‡¬ðŸ‡§ UK</TabsTrigger>
            <TabsTrigger value="canada" className="flex items-center gap-1.5 text-sm">ðŸ‡¨ðŸ‡¦ Canada</TabsTrigger>
            <TabsTrigger value="nz" className="flex items-center gap-1.5 text-sm">ðŸ‡³ðŸ‡¿ New Zealand</TabsTrigger>
            <TabsTrigger value="singapore" className="flex items-center gap-1.5 text-sm">ðŸ‡¸ðŸ‡¬ Singapore</TabsTrigger>
            <TabsTrigger value="ireland" className="flex items-center gap-1.5 text-sm">ðŸ‡®ðŸ‡ª Ireland</TabsTrigger>
            <TabsTrigger value="southafrica" className="flex items-center gap-1.5 text-sm">ðŸ‡¿ðŸ‡¦ South Africa</TabsTrigger>
          </TabsList>
