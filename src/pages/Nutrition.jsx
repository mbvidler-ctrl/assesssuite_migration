...
export default function NutritionPage() {
    ...
    <Card className="bg-white/80 backdrop-blur-sm border-slate-200/60">
      ...
      <CardContent className="space-y-4">
        <div className="bg-green-50 border border-green-200 p-4 rounded-lg">
          <h4 className="font-semibold text-green-900 mb-3">✓ Within Scope</h4>
          <ul className="space-y-2 text-sm text-green-800">
            {within.map((item, i) => <li key={i} className="flex items-start gap-2"><span className="text-green-600 font-bold">•</span><span>{item}</span></li>)}
          </ul>
        </div>
        <div className="bg-red-50 border border-red-200 p-4 rounded-lg">
          <h4 className="font-semibold text-red-900 mb-3">✗ Outside Scope (Refer to Dietitian)</h4>
          <ul className="space-y-2 text-sm text-red-800">
            {outside.map((item, i) => <li key={i} className="flex items-start gap-2"><span className="text-red-600 font-bold">•</span><span>{item}</span></li>)}
          </ul>
        </div>
  ...
  const SCOPE_DATA = {
    au: {
      title: "Australia — Exercise Physiology Nutrition Scope",
      icon: "text-amber-600",
      within: [
      ...
      outside: [
        "Medical Nutrition Therapy (MNT) — prescribing therapeutic diets",
    ...
    us: {
      title: "USA — Clinical Exercise Physiologist Nutrition Scope",
      icon: "text-blue-600",
      within: [
      ...
      referTo: "Refer to: Registered Dietitian Nutritionist (RDN) for all therapeutic nutrition needs. Note: Nutrition practice laws vary by state — default to education-only.",
    ...
    uk: {
      title: "UK — Clinical Exercise Physiologist Nutrition Scope",
      icon: "text-blue-600",
      within: [
      ...
      referTo: "Refer to: Registered Dietitian (RD) — protected title regulated by HCPC. In UK, 'nutritionist' is not a protected title.",
    ...
    ca: {
      title: "Canada — Kinesiologist / Exercise Physiologist Nutrition Scope",
      icon: "text-red-600",
      within: [
      ...
      referTo: "Refer to: Registered Dietitian (RD) — regulated in all provinces. Note: Nutrition practice is regulated differently across provinces — always check your provincial requirements.",
    ...
    nz: {
      title: "New Zealand — Exercise Physiologist Nutrition Scope",
      icon: "text-teal-600",
      within: [
      ...
      referTo: "Refer to: Registered Dietitian (RD) — regulated by Dietitians New Zealand. NZRD is the recognised credential.",
    ...
    sg: {
      title: "Singapore — Exercise Physiologist Nutrition Scope",
      icon: "text-red-600",
      within: [
      ...
      referTo: "Refer to: Registered Dietitian (SNDA — Singapore Nutrition and Dietetics Association). Dietetics is an AHPC-regulated allied health profession in Singapore.",
    ...
    ie: {
      title: "Ireland — Exercise Physiologist Nutrition Scope",
      icon: "text-green-600",
      within: [
      ...
      referTo: "Refer to: Registered Dietitian — regulated by CORU in Ireland. 'Dietitian' is a protected title. INDI is the professional body.",
    ...
    za: {
      title: "South Africa — Biokineticist Nutrition Scope",
      icon: "text-green-700",
      within: [
      ...
      referTo: "Refer to: Registered Dietitian — regulated by HPCSA (Dietetics and Human Nutrition board). ADSA is the professional body.",
  ...
  const RESOURCE_DATA = {
    au: [
      ...
      { title: "Dietitians Australia — Find an APD", desc: "Refer clients needing Medical Nutrition Therapy to an Accredited Practising Dietitian.", url: "https://dietitiansaustralia.org.au/find-dietitian", label: "Find an APD" },
      ...
      { title: "Nutrient Reference Values", desc: "Australian and NZ NRVs — RDIs, AIs, EARs and ULs for all nutrients.", url: "https://www.eatforhealth.gov.au/nutrient-reference-values", label: "View NRVs" },
    ],
    us: [
      { title: "Dietary Guidelines for Americans 2020–2025", desc: "Official USDA + HHS guidelines.", url: "https://www.dietaryguidelines.gov/resources/2020-2025-dietary-guidelines-online-materials", label: "View Guidelines" },
      ...
      { title: "Dietary Reference Intakes (DRIs)", desc: "National Academies nutrient reference standards — RDA/AI/EAR/UL.", url: "https://www.ncbi.nlm.nih.gov/books/NBK45182/", label: "View DRIs" },
    ...
    uk: [
      ...
      { title: "SACN Dietary Reference Values", desc: "Scientific Advisory Committee on Nutrition — nutrient reference values for the UK.", url: "https://www.gov.uk/government/publications/sacn-dietary-reference-values-for-energy", label: "View DRVs" },
      ...
      { title: "HCPC Register — Dietitians", desc: "Verify a dietitian's HCPC registration status in the UK.", url: "https://www.hcpc-uk.org/check-the-register/", label: "Check Register" },
    ],
    ca: [
      ...
      { title: "Health Canada — Nutrition", desc: "Federal nutrition policy, labelling regulations, and healthy eating resources.", url: "https://www.canada.ca/en/health-canada/services/food-nutrition.html", label: "Health Canada" },
      { title: "Canada's Food Guide — Professional Resources", desc: "Educator guides, handouts, and visual assets from Health Canada.", url: "https://food-guide.canada.ca/en/resources/", label: "Download Resources" },
    ],
    nz: [
      { title: "NZ Ministry of Health — Healthy Eating", desc: "Official healthy eating guidelines including resources for MÄori and Pacific populations.", url: "https://www.health.govt.nz/your-health/healthy-living/food-activity-and-sleep/healthy-eating", label: "View Guidelines" },
      ...
      { title: "NZ Nutrient Reference Values", desc: "Australia/NZ joint NRV tables — RDIs, AIs, EARs, and ULs.", url: "https://www.eatforhealth.gov.au/nutrient-reference-values", label: "View NRVs" },
    ...
    ie: [
      ...
      { title: "Healthy Ireland — Healthy Eating", desc: "HSE healthy eating guidelines, food diary tools, and patient resources.", url: "https://www2.hse.ie/healthy-you/food-and-nutrition/healthy-eating/", label: "HSE Nutrition" },
      ...
      { title: "CORU — Dietitians Registration", desc: "Verify dietitian registration with Ireland's CORU.", url: "https://coru.ie/public-protection/check-the-register/", label: "Check CORU Register" },
      { title: "Safefood", desc: "All-island food safety and nutrition agency — recipes, guides, and professional resources.", url: "https://www.safefood.net/", label: "Safefood Resources" },
    ...
    za: [
      ...
      { title: "HPCSA — Dietetics Board", desc: "Verify dietitian registration with the Health Professions Council of South Africa.", url: "https://www.hpcsa.co.za", label: "Check HPCSA Register" },
  ...
  const COUNTRY_FLAGS = { au: "🇦🇺 Australia", us: "🇺🇸 USA", uk: "🇬🇧 UK", ca: "🇨🇦 Canada", nz: "🇳🇿 New Zealand", sg: "🇸🇬 Singapore", ie: "🇮🇪 Ireland", za: "🇿🇦 South Africa" };
              ...
              <div className="grid md:grid-cols-2 gap-4">
                ...
                <Card className="bg-white/80 backdrop-blur-sm border-slate-200/60">
                  ...
                  <CardContent className="space-y-3">
                    <div>
                      <h4 className="font-semibold text-slate-900 text-sm mb-1">BMR — Mifflin-St Jeor</h4>
                      <div className="bg-slate-50 p-2 rounded text-xs font-mono">
                        <p><strong>Men:</strong> (10×wt) + (6.25×ht) − (5×age) + 5</p>
                        <p><strong>Women:</strong> (10×wt) + (6.25×ht) − (5×age) − 161</p>
                    ...
                    <div>
                      ...
                      <div className="text-xs text-slate-700 space-y-0.5">
                        <p>• Sedentary: × 1.2 &nbsp;• Light (1-3/wk): × 1.375</p>
                        <p>• Moderate (3-5/wk): × 1.55 &nbsp;• Very active: × 1.725</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
