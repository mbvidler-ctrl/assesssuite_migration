...
/**
 * @type {React.ForwardRefExoticComponent<React.HTMLAttributes<HTMLDivElement> & import("class-variance-authority").VariantProps<typeof alertVariants> & React.RefAttributes<HTMLDivElement>>}
 */
