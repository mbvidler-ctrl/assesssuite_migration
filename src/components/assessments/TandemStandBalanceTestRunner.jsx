...
function getInterpretation(score) {
  ...
  if (score === 2) return { text: "Moderate â€” monitor closely", color: "text-yellow-700" };
  if (score === 1) return { text: "Increased fall risk", color: "text-orange-700" };
  return { text: "High fall risk â€” unable to hold position", color: "text-red-700" };
}
    ...
    <div className="space-y-5 p-1">
      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500">SPPB balance component â€” fall risk assessment</p>
        </div>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800 space-y-2">
        <p className="font-semibold text-blue-900">ðŸ“‹ Clinician Instructions</p>
      ...
      <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm">
        <p className="font-semibold text-slate-700 mb-2">ðŸ“Š SPPB Scoring Criteria</p>
        <table className="w-full text-xs border border-slate-300 rounded overflow-hidden">
          ...
          <tbody>
            <tr className="border-t"><td className="p-2">â‰¥ 10 s</td><td className="p-2 font-bold">4 pts</td><td className="p-2 text-green-700">Low fall risk</td></tr>
            <tr className="border-t bg-white"><td className="p-2">3 â€“ 9.9 s</td><td className="p-2 font-bold">2 pts</td><td className="p-2 text-yellow-700">Moderate â€” monitor</td></tr>
        ...
        <p className="text-xs text-slate-500 mt-2">MCID: Change of â‰¥1 point. A tandem stand score of &lt;4 is associated with 2â€“3Ã— increased fall risk in community-dwelling older adults (Guralnik et al., 1994; Rossiter-Fornoff et al., 1995).</p>
      </div>
      ...
      <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-lg p-5 text-center space-y-4">
        ...
        {elapsed >= 10 && !timerRunning && (
          <p className="text-green-700 font-semibold text-sm">âœ… 10 seconds reached â€” Score: 4 pts</p>
        )}
        ...
        <div className="space-y-2">
          ...
          <div className="bg-indigo-50 border border-indigo-200 rounded-lg px-3 py-3 mt-1">
            <div className="flex justify-between items-center">
              ...
              <span className={`text-base font-bold ${interp?.color}`}>SPPB Score: {score}/4 â€” {interp?.text}</span>
            </div>
          </div>
        </div>
      )}
      ...
      <div className="bg-slate-100 border border-slate-200 rounded-lg p-3 text-xs text-slate-600 space-y-1">
        ...
        <p>1. Guralnik JM, Simonsick EM, Ferrucci L, et al. (1994). A short physical performance battery assessing lower extremity function: association with self-reported disability and prediction of mortality and nursing home admission. <em>Journal of Gerontology</em>, 49(2), M85â€“M94.</p>
        <p>2. Rossiter-Fornoff JE, Wolf SL, Wolfson LI, Buchner DM. (1995). A cross-sectional validation study of the FICSIT common data base static balance measures. <em>Journal of Gerontology: Medical Sciences</em>, 50A(6), M291â€“M297.</p>
        <p>3. Bohannon RW. (2006). Reference values for the timed up and go test: a descriptive meta-analysis. <em>Journal of Geriatric Physical Therapy</em>, 29(2), 64â€“68.</p>
        <p>4. Podsiadlo D & Richardson S. (1991). The timed "Up & Go": a test of basic functional mobility for frail elderly persons. <em>JAGS</em>, 39(2), 142â€“148.</p>
      </div>
