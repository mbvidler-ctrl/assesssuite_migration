...
export default function EditAssessmentModal({ assessment, onClose, onSaved }) {
  const [formData, setFormData] = useState({
    name: assessment.name || "",
    category: assessment.category || "",
    description: assessment.description || "",
    instructions: assessment.instructions || "",
    scoring_system: assessment.scoring_system || "",
    unit_of_measure: assessment.unit_of_measure || "",
    equipment_needed: assessment.equipment_needed || "",
    ...
    normative_data: assessment.normative_data || [],
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(newErrors).length === 0) {
      ...
      try {
        ...
        await base44.entities.Assessment.update(assessment.id, cleanedData);
  ...
  return (
    <Dialog open={true} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="text-xl font-bold">Edit Assessment</DialogTitle>
        </DialogHeader>
