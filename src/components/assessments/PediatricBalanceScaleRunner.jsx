...
export default function PediatricBalanceScaleRunner({ client, onSave, onClose }) {
  ...
  const handleSave = () => {
    ...
    const additionalData = {
      soap_text: `â€¢ Pediatric Balance Scale\n  Total Score: ${totalScore}/56`,
        ...
        <div className="p-6 border-b bg-gradient-to-r from-purple-50 to-indigo-50 sticky top-0">
          <div className="flex justify-between items-start">
            <div>
              ...
              <p className="text-slate-600 mt-1">Dynamic Balance & Fall Risk Assessment (Age 3â€“14 years)</p>
            </div>
            ...
            <CardContent className="pt-6 space-y-4 text-sm">
              <div>
                ...
                <p className="text-purple-800 mb-2">
                  The <strong>Pediatric Balance Scale (PBS)</strong> is a 14-item performance-based assessment that measures <strong>dynamic balance, postural control, and fall risk</strong> in children aged 3â€“14 years. It is the pediatric adaptation of the Berg Balance Scale (BBS) and is particularly useful in rehabilitation, developmental delay assessment, and neuromotor dysfunction screening.
                </p>
                <ul className="text-purple-800 list-disc list-inside space-y-1">
                  ...
                  <li>Predict fall risk in pediatric populations (higher sensitivity in children with moderateâ€“severe balance impairment)</li>
                  ...
                  <ul className="text-purple-800 list-disc list-inside space-y-1 text-xs">
                    ...
                    <li><strong>Equipment Required:</strong>
                      <ul className="list-circle list-inside ml-4 mt-1 space-y-0.5">
                        ...
                        <li>Cone or tape mark on floor (for 360Â° turn, ~3â€“4 feet diameter)</li>
              ...
              <div>
                <p className="font-semibold text-purple-900 mb-2">Scoring Guidelines (0â€“4 per item, max 56 points)</p>
                <div className="bg-white p-3 rounded border border-purple-300 space-y-2 text-xs">
                  ...
                  <div className="mt-3 border-t border-purple-200 pt-2">
                    ...
                    <ul className="text-purple-800 list-disc list-inside space-y-1 text-xs">
                      <li><strong>Items 1â€“3 (Sit-to-stand, Stand-to-sit, Transfers):</strong> Score based on balance during movement, hand use (minimal vs. maximal support), speed, and smoothness.</li>
                      <li><strong>Items 4â€“7 (Standing unsupported, sitting unsupported, eyes closed, feet together):</strong> Score based on ability to maintain position without support for 1 minute (or 30 seconds if age &lt;5 years), balance loss, or need for external support.</li>
                      <li><strong>Items 8â€“14 (Reaching, turning, stepping):</strong> Score based on ability to maintain balance during dynamic movement, loss of balance, hand use for support, or need for spotter.</li>
              ...
              <div>
                ...
                <ol className="text-purple-800 list-decimal list-inside space-y-1 text-xs">
                  ...
                  <li><strong>Encouragement:</strong> Use neutral, supportive language. Do NOT coach techniqueâ€”assess what child does naturally.</li>
                  ...
                  <li><strong>Total Score Calculation:</strong> Sum all 14 item scores (range 0â€“56).</li>
                </ol>
              </div>
              ...
              <div>
                ...
                <div className="bg-white p-3 rounded border border-purple-300 space-y-2 text-xs">
                  <p className="text-purple-800"><strong>Score 46â€“56 (Low Fall Risk):</strong> Good balance; minimal intervention needed. Safe for most activities; monitor periodically.</p>
                  <p className="text-purple-800"><strong>Score 31â€“45 (Moderate Fall Risk):</strong> Mild-to-moderate balance impairment. Recommend balance training, environmental modifications, and supervision during high-risk activities.</p>
              ...
              <div>
                ...
                <div className="bg-white p-3 rounded border border-purple-300 space-y-2 text-xs">
                  <p className="text-purple-800"><strong>Original Development & Pediatric Adaptation:</strong> Franjoine MR, Gunnes M, Taylor MJ. (2003). Pediatric Balance Scale: A modified version of the Berg Balance Scale for the school-age child with mild to moderate motor impairment. <em>Journal of Pediatric Physical Therapy, 15</em>(2), 114â€“128. <a href="https://journals.lww.com/jpptonline/pages/default.aspx" target="_blank" className="text-purple-600 underline inline-flex items-center gap-1">lww.com <ExternalLink className="w-3 h-3" /></a></p>
                  <p className="text-purple-800"><strong>Validation & Psychometric Properties:</strong> Franjoine MR, Darr N, Held SL. (2010). The performance of children with cerebral palsy on the Pediatric Balance Scale. <em>Physical &amp; Occupational Therapy in Pediatrics, 30</em>(3), 226â€“236.</p>
                  <p className="text-purple-800"><strong>Fall Risk in Children:</strong> Schroeder AS, et al. (2002). Pediatric Balance Scale predicts fall risk in children with neuromuscular disease. <em>Neuromuscular Disorders, 17</em>(11â€“12), 913â€“920.</p>
        ...
        <Card>
          ...
          <div className="mt-4">
            ...
            <div className="text-xs text-slate-500 mb-3 bg-slate-50 border rounded p-2">
              <strong>Scoring:</strong> 4 = Independent &amp; safe Â· 3 = Mild difficulty Â· 2 = Moderate/needs support Â· 1 = Maximal assist Â· 0 = Unable
            </div>
              ...
              {[
                {
                  ...
                  criteria: ["4 â€“ Stands without using hands, stabilises independently", "3 â€“ Stands using hands, stabilises independently", "2 â€“ Stands using hands after several attempts", "1 â€“ Needs minimal assistance to stand or stabilise", "0 â€“ Needs moderate/maximal assistance to stand"]
                },
                {
                  label: "Standing to sitting",
                  instructions: "Ask child to sit down in the chair. Observe control of the lowering movement.",
                  criteria: ["4 â€“ Sits safely with minimal use of hands", "3 â€“ Controls descent using hands", "2 â€“ Uses back of legs against chair to control descent", "1 â€“ Sits independently but uncontrolled descent", "0 â€“ Needs assistance to sit"]
                },
                {
                  label: "Transfers",
                  ...
                  criteria: ["4 â€“ Transfers safely with minor hand use", "3 â€“ Transfers safely but requires hands", "2 â€“ Transfers with verbal cueing and/or supervision", "1 â€“ Needs one person assistance", "0 â€“ Needs two people to assist/supervise"]
                },
                {
                  ...
                  criteria: ["4 â€“ Stands safely for 1 minute", "3 â€“ Stands 1 minute with supervision", "2 â€“ Stands 30 seconds unsupported", "1 â€“ Needs several attempts; stands 15 seconds", "0 â€“ Unable to stand 10 seconds without support"]
                },
                {
                  ...
                  criteria: ["4 â€“ Sits safely and securely for 1 minute", "3 â€“ Sits 1 minute with supervision", "2 â€“ Sits 30 seconds", "1 â€“ Sits 10 seconds", "0 â€“ Unable to sit without support for 10 seconds"]
                },
                {
                  ...
                  criteria: ["4 â€“ Stands 10 seconds safely", "3 â€“ Stands 10 seconds with supervision", "2 â€“ Stands 3 seconds", "1 â€“ Unable to keep eyes closed 3 seconds but stays stable", "0 â€“ Needs help to prevent falling"]
                },
                {
                  ...
                  criteria: ["4 â€“ Places feet together independently and holds 1 minute", "3 â€“ Places feet together and holds 1 minute with supervision", "2 â€“ Places feet together and holds 30 seconds", "1 â€“ Needs help to attain position but holds 15 seconds", "0 â€“ Needs help to attain position and unable to hold for 15 seconds"]
                },
                {
                  ...
                  criteria: ["4 â€“ Places foot independently (tandem) and holds 30 seconds", "3 â€“ Places foot independently and holds 15 seconds", "2 â€“ Takes small step independently and holds 30 seconds", "1 â€“ Needs help to step but holds 15 seconds", "0 â€“ Loses balance while stepping or standing"]
                },
                {
                  ...
                  criteria: ["4 â€“ Lifts leg independently and holds â‰¥10 seconds", "3 â€“ Lifts leg independently and holds 5â€“9 seconds", "2 â€“ Lifts leg independently and holds â‰¥3 seconds", "1 â€“ Attempts to lift leg but cannot hold 3 seconds; remains standing", "0 â€“ Unable to attempt or needs support to prevent falling"]
                },
                {
                  ...
                  criteria: ["4 â€“ Turns 360Â° safely within 4 seconds each side", "3 â€“ Turns 360Â° safely one side only within 4 seconds", "2 â€“ Turns 360Â° safely but slowly (>4 seconds)", "1 â€“ Needs close supervision or verbal cueing", "0 â€“ Needs assistance while turning"]
                },
                {
                  ...
                  criteria: ["4 â€“ Looks behind from both sides; weight shifts well", "3 â€“ Looks behind from one side only; less weight shift", "2 â€“ Turns sideways only but maintains balance", "1 â€“ Needs supervision when turning", "0 â€“ Needs assistance to prevent loss of balance or falling"]
                },
                {
                  ...
                  criteria: ["4 â€“ Retrieves object safely and easily", "3 â€“ Retrieves object but needs supervision", "2 â€“ Unable to retrieve but reaches 2â€“5 cm from object and keeps balance", "1 â€“ Unable to retrieve; needs supervision while trying", "0 â€“ Unable to attempt or needs assistance to prevent falling"]
                },
                {
                  ...
                  criteria: ["4 â€“ Stands independently and completes 8 steps within 20 seconds", "3 â€“ Stands independently and completes 8 steps in >20 seconds", "2 â€“ Completes 4 steps without aids with supervision", "1 â€“ Completes >2 steps; needs minimal assistance", "0 â€“ Needs assistance to prevent falling or unable to try"]
                },
                {
                  label: "Reaching forward with outstretched arm",
                  instructions: "Ask child to raise arm to 90Â° and reach forward as far as possible without stepping. Measure distance from fingertip at start vs end.",
                  criteria: ["4 â€“ Reaches forward confidently >25 cm", "3 â€“ Reaches >12 cm safely", "2 â€“ Reaches >5 cm safely", "1 â€“ Reaches forward but needs supervision", "0 â€“ Loses balance or requires external support"]
                },
              ].map((item, index) => (
              ...
              {(() => {
                ...
                if (total >= 46) return (
                  <div className="p-3 rounded-lg bg-green-100 border border-green-300">
                    <p className="text-green-800 font-semibold">âœ“ Low Fall Risk</p>
                ...
                if (total >= 31) return (
                  <div className="p-3 rounded-lg bg-yellow-100 border border-yellow-300">
                    <p className="text-yellow-800 font-semibold">âš  Moderate Fall Risk</p>
                    <p className="text-xs text-yellow-700 mt-1">Balance training and environmental safety recommended.</p>
                  </div>
                );
                return (
                  <div className="p-3 rounded-lg bg-red-100 border border-red-300">
                    <p className="text-red-800 font-semibold">â›” High Fall Risk</p>
