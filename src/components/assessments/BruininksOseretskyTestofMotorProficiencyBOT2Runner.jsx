    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6">
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800 space-y-1 mb-4">
          ...
          <p><strong>Overview:</strong> BOT-2 assesses motor proficiency in 4â€“21 year olds. Comprises 8 subtests: Fine Motor Precision, Fine Motor Integration, Manual Dexterity, Bilateral Coordination, Balance, Running Speed and Agility, Upper-Limb Coordination, and Strength.</p>
          <p><strong>Complete Form:</strong> All 8 subtests (~45â€“60 min). <strong>Short Form:</strong> 14 selected items (~15â€“20 min). Both yield age-equivalent scores and standard scores.</p>
        ...
        <div className="bg-slate-50 border border-slate-200 rounded-lg p-3 text-sm space-y-2 mb-4">
          <p className="font-semibold text-slate-700">ðŸ“Š Composite Score Classification</p>
          <div className="overflow-x-auto">
            <table className="w-full text-xs border border-slate-300 rounded">
              ...
              <tbody>
                <tr className="border-t"><td className="p-2">â‰¥70</td><td className="p-2 text-green-700">Above Average / Well Above Average</td></tr>
                <tr className="border-t bg-white"><td className="p-2">41â€“69</td><td className="p-2 text-teal-700">Average</td></tr>
                <tr className="border-t"><td className="p-2">31â€“40</td><td className="p-2 text-yellow-700">Below Average</td></tr>
                <tr className="border-t bg-white"><td className="p-2">â‰¤30</td><td className="p-2 text-red-700">Well Below Average</td></tr>
              </tbody>
            </table>
          </div>
          <p className="text-xs text-slate-500">Composite scores have M=50, SD=10. Subtest scale scores M=15, SD=5. Age norms from 4â€“21 years. Source: Bruininks & Bruininks (2005).</p>
        </div>
