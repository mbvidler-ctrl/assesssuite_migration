      ...
      <div className="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto p-6">
        <Card>
          ...
          <div className="bg-slate-100 border border-slate-200 rounded-lg p-3 text-xs text-slate-600 space-y-1 mb-4">
            ...
            <p>Jackson AS & Pollock ML. (1978). Generalized equations for predicting body density of men. <em>British Journal of Nutrition, 40</em>(3), 497–504.</p>
            <p>Jackson AS, Pollock ML, & Ward A. (1980). Generalized equations for predicting body density of women. <em>Medicine & Science in Sports & Exercise, 12</em>(3), 175–181.</p>
            <p>Siri WE. (1956). The gross composition of the body. <em>Advances in Biological and Medical Physics, 4</em>, 239–280. [Siri equation: BF% = (495/BD) − 450]</p>
          </div>

          {/* Clinician Instructions */}
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 text-sm text-blue-800 space-y-1 mb-4">
            <p className="font-semibold">📋 Administration Instructions (Jackson & Pollock Protocol)</p>
            ...
            <p><strong>Technique:</strong> Grasp skinfold firmly with thumb and index finger ~1 cm from site. Apply calipers perpendicular to fold. Read after 1–2 seconds. Take 2–3 readings per site, rotating through sites. Average if within 1–2 mm; discard outliers.</p>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-xs border border-slate-300 rounded">
                ...
                <tbody>
                  ...
                  <tr className="border-t bg-white"><td className="p-2">Good</td><td className="p-2 text-center">11–13%</td><td className="p-2 text-center">14–17%</td><td className="p-2 text-center">16–19%</td><td className="p-2 text-center">20–23%</td></tr>
                  <tr className="border-t"><td className="p-2">Fair</td><td className="p-2 text-center">14–20%</td><td className="p-2 text-center">18–24%</td><td className="p-2 text-center">20–27%</td><td className="p-2 text-center">24–31%</td></tr>
                  <tr className="border-t bg-white"><td className="p-2">Poor</td><td className="p-2 text-center">≥21%</td><td className="p-2 text-center">≥25%</td><td className="p-2 text-center">≥28%</td><td className="p-2 text-center">≥32%</td></tr>
                </tbody>
              </table>
            </div>
          </div>
