...
export default function SixMeterWalkStandaloneWrapper({ assessment, client, clientAssessment, onSave, onClose, clinicianNotes }) {
  ...
  const handleSaveTest = async (data) => {
    ...
    try {
      ...
      let objectiveText = formattedObjective
