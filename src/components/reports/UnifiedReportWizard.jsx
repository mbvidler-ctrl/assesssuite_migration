...
<div class="lh"><h1>${(clinician && clinician.clinic_name) || "Allied Assess"}</h1><div class="cl">${clinician ? (clinician.clinic_address || "") : ""}${clinician && clinician.clinic_phone ? `<br/>${clinician.clinic_phone}` : ""}</div></div>
