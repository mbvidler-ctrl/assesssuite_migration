# Incident report — production clinical-AI outage, 21–28 July 2026

Prepared for: Maxwell Vidler (clinic owner) and future auditors.
...
| Item | Status |
|---|---|
| G1 — Add an explicit approval trigger: any change that reduces production feature availability requires recorded owner sign-off before merge. No such trigger existed | Recommended |
...
*Document control — Author: Claude Code review session. Date: 28 July 2026. Status: draft for owner review.*
