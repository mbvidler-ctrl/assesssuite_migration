...
const REQUIRED = [
  ...
  'OPENAI_API_KEY',
  'SENTRY_DSN',
  'ASSESSSUITE_DASHBOARD_METRICS_TOKEN',
...
const FORBIDDEN_OPAQUE_OVERRIDES = [
  ...
  'AI_USAGE_USER_ROLLING_24H_USD',
  'AI_USAGE_USER_ROLLING_24H_CALLS',
  'AI_USAGE_GLOBAL_MONTHLY_USD',
  'AI_USAGE_INVOKE_FAST_ESTIMATE_USD',
  'AI_USAGE_INVOKE_QUALITY_ESTIMATE_USD',
  'AI_USAGE_TRANSCRIPTION_ESTIMATE_USD',
  'AI_USAGE_SOAP_ESTIMATE_USD',
  'AI_USAGE_DOCUMENT_EXTRACTION_ESTIMATE_USD',
  'GENERAL_CLINICAL_LLM_MAX_OUTPUT_UNITS',
];
