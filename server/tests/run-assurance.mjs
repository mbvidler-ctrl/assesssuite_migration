...
const suites = [
  ...
  'transcription-provider-contract.test.mjs',
  'persistent-transcription-session.test.mjs',
  'integration-connectors.test.mjs',
  'integration-management-route.test.mjs',
  'halaxy-sync.test.mjs',
